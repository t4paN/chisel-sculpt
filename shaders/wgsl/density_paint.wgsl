...
// dual anchor (mirror), writes the density buffer directly and appends touched
...
//   0  positions (read)   41 density (read_write)   6 dirty list (read_write)
